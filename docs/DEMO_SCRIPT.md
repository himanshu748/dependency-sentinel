...
| 0:25–0:50 | Seeded input | Locked dependency snapshot; explain that the example data is fictional |
...
| 1:45–2:30 | Pending decision, then approve | Approve or reject validated patch report; demonstrate the before/after write invariant |
| 2:30–3:15 | Alternate scenario or rejection | Show uncertainty, conflict, failure or rejection honestly |
| 3:15–3:45 | Architecture PNG + Strands code | Name Strands Agents SDK; distinguish scripted demo from live inference |
| 3:45–4:15 | Working result and limitations | Local SQLite run ledger; source unchanged; current deployment status and why the result matters |
